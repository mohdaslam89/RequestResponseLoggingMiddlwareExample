...
namespace MiddlewareExample.Middleware
{
    ...
    // https://exceptionnotfound.net/usingrespo-middleware-to-log-requests-and-responses-in-asp-net-core/
    ...
    public class RequestResponseLogMiddleware
    {
        ...
        {
            // Fist get the incomming request.
        ...
        private async Task<string> FormatResponse(HttpResponse response)
        {
            ...
            return $"{response.StatusCode}: {text} - Update Response Into Middleware";
        }
    }
    ...
    {
        public static IApplicationBuilder UseRequestResponseLogMiddleware(this IApplicationBuilder builder)
        {
